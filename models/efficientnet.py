# -*- coding: utf-8 -*-
"""EfficientNetB0 dinesh.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1vZB6pyQKpYWWmx3tlg7EMFRDL1bII5c5
"""
...
''' Data Path '''
train_path = '/content/drive/MyDrive/Project2025/oralcancer 2'

# Check if the directory exists
if not os.path.exists(train_path):
    print(f"Error: Directory '{train_path}' not found.")
    # You might want to handle this error by creating the directory or exiting the script
else:
    File = []
...
for f in os.listdir(train_path):
    ...
    # Check if 'path' is a directory before iterating through its contents
    if os.path.isdir(path):
        for im in os.listdir(path):
            ''' loading an image '''
            # Join the path with the image filename
            image_path = os.path.join(path, im)
            # Check if 'image_path' is a file before loading it as an image
        ...
        count=count+1 # Increment the count after processing all images in a directory
...
# Using EfficientNetB0 — change to B1, B2, etc. if needed
...
''' training '''
history=model.fit(data_aug.flow(X_train, y_train, batch_size=16), validation_data=(X_test, y_test), epochs=75)
